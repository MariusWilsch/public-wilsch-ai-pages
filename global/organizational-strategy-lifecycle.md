...
**Moved to standalone document:** [Position Build Process](https://mariuswilsch.github.io/public-wilsch-ai-pages/global/position-build-process)

Covers the complete lifecycle: Stage 1 (Structure) → Stage 2 (Prototype via BDP) → Stage 3 (Replace Yourself) → Stage 4 (Repeat). This document covers Stage 1 artifacts only.
