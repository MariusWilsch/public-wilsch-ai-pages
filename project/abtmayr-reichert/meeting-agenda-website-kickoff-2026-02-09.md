...
# Meeting-Agenda: Website-Kickoff Klimafolgen & Renovierungsverein
...
- Bildsprache: Welche Bilder/Icons sollen den Verein repräsentieren?
- Gibt es Referenz-Websites, die als Vorbild dienen?

### 4. Klimafolgen Schutzverein — Mitgliedsformulare und Zahlungsabwicklung

"Werden Sie Mitglied" und "Fördern Sie uns" — zwei zentrale Handlungsaufforderungen. Beiträge von 500–5.000 EUR/Jahr.

- Welche Felder sollen die Formulare enthalten? (Name, Organisation, Gemeindegröße, etc.)
- Unterschied zwischen Mitglied und Förderer — verschiedene Formulare?
- Online-Zahlung gewünscht oder Beitritt per Rechnung/Überweisung?
- Bestehender Aufnahmeantrag vorhanden (Papier/PDF)?

### 5. Klimafolgen Schutzverein — Inhaltspflege und CMS
...
### 6. Klimafolgen Schutzverein — Zertifizierung, Domain und Impressum

Zertifizierung für Mitgliedsgemeinden und technische Infrastruktur.

- Zertifizierung: Was bedeutet das konkret? (Siegel, Urkunde, Website-Badge?)
- Ist eine Domain für den Klimafolgen Schutzverein bereits registriert?
- Falls ja: bei welchem Anbieter? DNS-Zugangsdaten bereitstellen
