...
**To resolve:** Whether ParentId should still be provided explicitly despite the server deriving it from nesting, or whether nesting alone is the intended contract.
